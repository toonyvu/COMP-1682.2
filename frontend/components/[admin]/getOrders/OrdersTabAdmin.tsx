...
import type { OrderAdmin, OrderItemsAdmin } from "@/types/types";
      ...
      <div className="flex flex-col">
        ...
        {orders && (
          <div className="space-y-6">
            {orders.map((order: OrderAdmin) => (
              <div
                onClick={() =>
                  router.push(
                    `/admin/dashboard/orders/${order.cus_order_id}?userId=${order.user_id}`,
                  )
                }
                key={order.id}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    {order.items.map((item: OrderItemsAdmin) => (
                      <div
                        key={item.mealkit_id}
