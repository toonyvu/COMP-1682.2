...
"[project]/Documents/PRJ/goodrecipes/lib/api/recipes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getAllRecipes() {
    ...
    const result = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8080")}/dashboard`, {
        method: "GET",
        headers: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PRJ$2f$goodrecipes$2f$lib$2f$api$2f$recipes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/PRJ/goodrecipes/lib/api/recipes.ts [app-client] (ecmascript)");
        ...
        "MealkitList.useEffect": ()=>{
            const fetchData = {
                "MealkitList.useEffect.fetchData": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PRJ$2f$goodrecipes$2f$lib$2f$api$2f$recipes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllRecipes"])();
                        setRecipes(data);
                    } catch (err) {
                        console.log(err);
                        router.push("/");
...
_s(MealkitList, "j6m802+Had/klmcSFNryDuB7sL8=", false, function() {
    return [
...
//# sourceMappingURL=Documents_PRJ_goodrecipes_914440e3._.js.map