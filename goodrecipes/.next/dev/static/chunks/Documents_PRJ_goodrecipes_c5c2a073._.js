...
"[project]/Documents/PRJ/goodrecipes/lib/api/getRecipes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PRJ$2f$goodrecipes$2f$lib$2f$api$2f$getRecipes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/PRJ/goodrecipes/lib/api/getRecipes.ts [app-client] (ecmascript)");
;
        ...
        "MealkitList.useEffect": ()=>{
            const fetchData = {
                "MealkitList.useEffect.fetchData": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$PRJ$2f$goodrecipes$2f$lib$2f$api$2f$getRecipes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllRecipes"])();
                        setRecipes(data);
                    } catch (err) {
                        console.log(err);
                        router.push("/");
...
_s(MealkitList, "5eLD/xF/OWywgWIuKcp8+ZH5v3g=", false, function() {
    return [
...
//# sourceMappingURL=Documents_PRJ_goodrecipes_c5c2a073._.js.map